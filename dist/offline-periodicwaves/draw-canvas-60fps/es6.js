...
export const draw = function (getData, lenght, canvas = null) {
    ...
    var zoomScale = 1, zoomXscale = 1;
    const height = canvas.getAttribute("height") || canvas.parentElement.clientHeight;
    const width = canvas.getAttribute("width") || canvas.parentElement.clientWidth;
