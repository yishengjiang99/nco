...
(function () {
    ...
    var version = '0.9.0', settings = {}, mouse_is_down = false, keysDown = {}, key_map = {
        65: 'Cl',
        87: 'C#l',
        83: 'Dl',
        69: 'D#l',
    ...
    var getFrequencyOfNote = function (note) {
        var notes = ['A', 'A#', 'B', 'C', 'C#', 'D', 'D#', 'E', 'F', 'F#', 'G', 'G#'], key_number, octave;
        if (note.length === 3) {
    ...
    var orderNotes = function (notes_to_order) {
        var i, keyOffset = 0, number_of_notes_to_order = notes_to_order.length, ordered_notes = [];
    ...
    var styleBlackKey = function (key) {
        var white_key_width = getWhiteKeyWidth(getTotalWhiteKeys()), black_key_width = Math.floor(white_key_width / 2);
    ...
    */
    ...
    var createKeys = function () {
        var that = this, i, key, keys = [], note_counter = 0, octave_counter = settings.startOctave, total_white_keys = getTotalWhiteKeys();
