...
async function init() {
	...
	let brk = 0x7fff;
	const sbrk = function (size: number) {
	...
	const sin_table = instance.exports.sin_table as CallableFunction;
	const fft = instance.exports.FFT as CallableFunction;
	const ifft = instance.exports.iFFT as CallableFunction;
	const bitreverse = instance.exports.bit_reverse as CallableFunction;
	...
	console.log(complex); bitreverse(complex, 5);
	...
	fft(complex, 5, sntl); bitreverse(complex, 5);
