...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'read.data';
      var REMOTE_PACKAGE_BASE = 'read.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_read.data');

      };
      Module['addRunDependency']('datafile_read.data');
   ...
   loadPackage({"files": [{"filename": "/file.sf2", "start": 0, "end": 31281186, "audio": 0}], "remote_package_size": 31281186, "package_uuid": "c345baa6-13d3-42b4-9756-10d14dfd2f39"});
...
var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 222298112;
...
assert(INITIAL_MEMORY == 222298112, 'Detected runtime INITIAL_MEMORY setting.  Use -s IMPORTED_MEMORY to define wasmMemory dynamically');
...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    //assert(wasmMemory.buffer.byteLength === 222298112);
